  ...
  return (
    <section className="relative w-full overflow-hidden bg-ink">
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col items-start">
        ...
        <div className="relative flex w-full items-center justify-center gap-[87px] px-[80px] pb-[90px] pt-[140px] max-lg:flex-col max-lg:items-center max-lg:text-center max-lg:gap-[32px] max-md:px-[24px] max-sm:px-[16px] max-md:py-[48px] max-md:pt-[112px]">
          <GlowEllipse
